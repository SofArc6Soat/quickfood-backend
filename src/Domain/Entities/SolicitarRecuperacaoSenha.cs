...
{
    public class SolicitarRecuperacaoSenha : Entity, IAggregateRoot
    {
        public string Email { get; private set; }

        public SolicitarRecuperacaoSenha(string email)
        {
            Id = Guid.NewGuid();
            Email = email;
        }
    ...
    public class ValidarSolicitacaoRecuperacaoSenha : AbstractValidator<SolicitarRecuperacaoSenha>
    {
