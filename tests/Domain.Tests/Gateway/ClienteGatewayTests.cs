...
public class ClienteGatewayTests
{
    ...
    public void DeveVerificarClienteExistente()
    {
        ...
        // Configura o mock para retornar clienteDb quando a expressão corresponde ao cliente criado
    ...
    public async Task DeveObterTodosClientesAsync()
    {
        ...
        var clientesDb = new List<ClienteDb>
            {
                new ClienteDb { Id = Guid.NewGuid(), Nome = "João Silva", Email = "joao@teste.com", Cpf = "12345678901", Ativo = true }
            };
